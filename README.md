...
My most recent developpment sought me working with the Zoological Society of London (ZSL for short) for the duration of 4-5 weeks creating an app based on the amount of Green House Gases released during the manufacturing and production proccess of four products, with the app based around a green house gas chain and the arragment of said chain, refering to the user's memory and ability to proccess (memory game) . 
